export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Chapter Command Center",
    "Operational table: Chapter operating system",
  ...
  "releaseChecklist": [
    ...
    "Launch Readiness reaches production threshold",
    "Role Coverage is documented with evidence",
    "Impact Cadence has no unresolved blocker",
    "Operating packet verified",
    "90-day plan verified",
    "Sponsor summary verified"
  ],
  "operations": [
